...
/**
 * Created by mingjingtang on 6/27/17.
 */
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < featureArray.length(); i++){
                ...
                double magnitude = earthquakeObjectProperties.getDouble("mag");
                String place = earthquakeObjectProperties.getString("place");
                long longTime = earthquakeObjectProperties.getLong("time");
                String url = earthquakeObjectProperties.getString("url");

                Earthquake earthquake = new Earthquake(magnitude,place,longTime,url);
